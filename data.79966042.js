var e="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},t={},n={},r=e.parcelRequire8e87;async function a(){let e;document.querySelector("#mycontainer").insertAdjacentHTML("beforeend",searchBar);let t=new window.URLSearchParams(document.location.search),n=t.get("edition"),r=t.get("bareedition")||n.replace(/\d+/g,"").split("-")[1].trim(),a=t.get("type")||"section",o=t.get("num"),i=t.get("grade");if(!r||!o&&"full"!=a)return;window.showSpinningWheel("#mycontainer","beforeend"),"full"==a?e=`editions/${n}`:"section"==a?e=`editions/${n}/sections/${o}`:"single"==a&&(e=`editions/${n}/${o}`);let d=await getJSON("isocodes/iso-codes",quranLinks),[c,l]=await getJSON(["editions",e]),[s,h,u]=c[r].collection.filter(e=>e.name==n).map(e=>[e.name,e.language,e.direction])[0],w=l.hadiths;if(i&&(i=i.trim().toLowerCase(),w=w.filter(e=>e.grades.some(e=>e.grade.toLowerCase().includes(i)))),"section"==a&&isObject(l?.metadata?.section)){let[e,t]=Object.entries(l.metadata.section).flat();document.querySelector("#mycontainer").insertAdjacentHTML("beforeend",`<h2 class="text-center">Section ${e}: ${t}</h2>`)}for(let e of w=w.filter(e=>e?.text))document.querySelector("#mycontainer").appendChild(getHadithCardElem(e,n,u,h,d));window.removeSpinningWheel(),window.location.hash=window.getHashTextFragment()}null==r&&((r=function(e){if(e in t)return t[e].exports;if(e in n){var r=n[e];delete n[e];var a={id:e,exports:{}};return t[e]=a,r.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){n[e]=t},e.parcelRequire8e87=r),(0,r.register)("kqKQD",function(e,t){window.htmlHadithContainer=`    
...
//# sourceMappingURL=data.79966042.js.map
