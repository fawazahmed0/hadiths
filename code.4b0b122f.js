var e="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},t={},n={},r=e.parcelRequire8e87;async function a(){window.showSpinningWheel("#mycontainer","beforeend");let e=await window.getJSON("editions"),t={};["bukhari","muslim","nasai","abudawud","tirmidhi","ibnmajah","malik"].concat(Object.keys(e)).forEach(n=>t[n]=e[n]),e=t;let n=getElement("ul",{class:"list-group"}),r=0;for(let[t,a]of Object.entries(e)){r++;let e=getElement("li",{class:"list-group-item"}),o=getElement("a",{href:`#collapse${r}`,"data-bs-toggle":"collapse",role:"button"});o.innerText=a.name,e.appendChild(o);let i=getElement("ul",{class:"list-group collapse",id:`collapse${r}`});for(let e of a.collection){let n=getElement("li",{class:"list-group-item"}),r=new window.URLSearchParams;r.set("edition",e.name),r.set("bareedition",t);let a=getElement("a",{href:`sections.html?${r.toString()}`});a.innerText=e.language,n.appendChild(a),i.appendChild(n)}e.appendChild(i),n.appendChild(e)}removeSpinningWheel(),document.querySelector("#mycontainer").appendChild(n)}null==r&&((r=function(e){if(e in t)return t[e].exports;if(e in n){var r=n[e];delete n[e];var a={id:e,exports:{}};return t[e]=a,r.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){n[e]=t},e.parcelRequire8e87=r),(0,r.register)("kqKQD",function(e,t){window.htmlHadithContainer=`    
...
//# sourceMappingURL=code.4b0b122f.js.map
